...
- [Sobelow](docs/scanners/sobelow.md) - Execution of [sobelow](https://github.com/nccgroup/sobelow) 0.11.1 Perform static code analysis against Elixir/Phoenix projects in order to identify insecure code patterns
